...
function asAmirror(str) {
  ...
  var nuevoStr = str.split(' ');
  var invertido = nuevoStr.map( function (letra) {
...
function capicua(numero){
  ...
  var converStr = numero.toString();
  var invertido = converStr.split('').reverse().join('');
  if(converStr === invertido){
    return "Es capicua";
  }
